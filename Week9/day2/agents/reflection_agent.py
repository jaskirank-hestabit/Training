...
- Identify gaps, overlaps, contradictions across the worker outputs
- Synthesize all outputs into ONE improved, coherent, comprehensive answer
- Fill in any missing context
- Do NOT validate, do NOT plan new tasks
- Output format: A clear, well-structured improved answer
