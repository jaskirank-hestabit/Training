...
Creates data/memory/long_term.db

Stores:
  - Conversation turns (episodic memory)
  - Important facts summarized by agents (semantic memory)

This is the durable layer that survives restarts and accumulates
across all sessions over time.
"""
