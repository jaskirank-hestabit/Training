...
def plan_tasks(user_query: str) -> list[dict]:
    """
    Uses the Orchestrator agent to decompose user_query into subtasks.
    Returns a list of task dicts: [{"id": ..., "description": ...}, ...]
    Falls back to a single task if parsing fails.
    """
